...
JessMA 核心依赖包：
-----------------------------------------------
1、JessMA 框架有 4 个基础依赖包：cglib-nodep-x.x.x.jar、dom4j-x.x.x.jar、log4j-api-2.x.x.jar、log4j-core-2.x.x.jar
...
4、加入 MyJessMA 项目依赖的 jar 包：
    <A> 方式一：在 MyEclipse 中创建三个名称分别为“jessma-lib”、“spring-lib”和“guice-lib”的 User Library，并把 jessma-lib/required、 jessma-lib/optional、spring-lib 和 guice-lib 文件夹下的 jar 包加入其中
